...
export default function Index() {
  return (
    <>
    <Head>
      <title>St. Mary's Lighthouse Project</title>// <link rel="icon" href="/favicon.ico" />
    </Head>
    <Container maxWidth="lg">
      <MyGrid>
        <img src="lighthouse-icon.png" />
      ...
      <Box my={4}>
        ...
        The black and white striped lighthouse is one of the oldest military structures in Brazil and an iconic Salvador's landmarks. <br />
